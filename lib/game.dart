...
class _GameScreenState extends State<Game> {
  ...
  Widget build(BuildContext context) {
    ...
    var defaultSettings =
        ModalRoute.of(context)!.settings.arguments as DefaultSettings;
    ...
    void doAttack() {
      defaultSettings.enemy.health =
          defaultSettings.enemy.health! - defaultSettings.character.damage!;
      gameLogic();
      setState(() {
        ...
        children: [
          Container(
            ...
            child: Row(
                ...
                children: [
                  Text(
                    defaultSettings.character.health.toString(),
                  ...
                  Text(
                    defaultSettings.enemy.health.toString(),
                    style: const TextStyle(
                        color: Colors.red,
                        fontSize: 55,
                        fontWeight: FontWeight.bold),
            ...
            child: Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Image.asset(defaultSettings.character.imagePath(),
                        scale: 0.3),
                  ),
                  Image.asset(
                    defaultSettings.enemy.imagePath(),
                    scale: 1.3,
                  )
                ]),
          ),
